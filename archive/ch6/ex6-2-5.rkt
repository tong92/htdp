...
#reader(lib "htdp-advanced-reader.ss" "lang")((modname ex6-2-5) (read-case-sensitive #t) (teachpacks ((lib "convert.rkt" "teachpack" "htdp") (lib "guess.rkt" "teachpack" "htdp") (lib "guess-gui.rkt" "teachpack" "htdp") (lib "master.rkt" "teachpack" "htdp") (lib "draw.rkt" "teachpack" "htdp"))) (htdp-settings #(#t constructor repeating-decimal #t #t none #f ((lib "convert.rkt" "teachpack" "htdp") (lib "guess.rkt" "teachpack" "htdp") (lib "guess-gui.rkt" "teachpack" "htdp") (lib "master.rkt" "teachpack" "htdp") (lib "draw.rkt" "teachpack" "htdp")) #f)))
;; Constants
(define WIDTH 50)
(define HEIGHT 160)
...
(define (next color)
  (cond
    [(and (symbol=? color 'red) (switch 'red 'green)) 'green]
    [(and (symbol=? color 'yellow) (switch 'yellow 'red)) 'red]
    [(and (symbol=? color 'green) (switch 'green 'yellow)) 'yellow]
  )
)

(define next-color1 (next 'red))
(define next-color2 (next next-color1))
(define next-color3 (next next-color2))
(define next-color4 (next next-color3))